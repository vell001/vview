...
int post_num = PostManager.getPublishPostNum();
int page_count = 1;
...
<div class="content">
	...
	<ul id="top_topic_ul">
		<%
			posts = PostManager.getPublishPostsByScore(0, 6);
			    	it = posts.iterator();
			    	p = null;
				for(i=0; i<6; i++) {
			if(it.hasNext()){
    ...
    <div class="posts">
    	<%
    		if(page_num != 0) {
    	    		    		posts = PostManager.getPublishPosts(post_info_num*(page_num-1), post_info_num);
    	    	    	}else {
    	    	    		posts = PostManager.getPublishPosts(0,post_info_num);
    	    	    	}
    	    	    	it = posts.iterator();
    	    	    	p = null;
